...
$ini[] = '[fabrik.com_fabrik_admin_sys]';
		...
		while (false !== ($entry = readdir($handle)))
		{
			if ($entry !== '.' && $entry !== '..')
			{
				...
				if (is_dir($langFolder))
				{
					...
					$ini[] = '[fabrik.plg_' . $type . '_' . $entry . '_sys]';
