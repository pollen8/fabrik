					...
					<?php if ($group->editable) { ?>
						<div class="fabrikGroupRepeater">
							...
							<a class="addGroup" href="#">
								<?php echo Html::image('plus-sign.png', 'form', $this->tmpl, array('class' => 'fabrikTip', 'title' => FText::_('COM_FABRIK_ADD_GROUP')));?>
							</a>
							<?php } ?>
							<?php if ($group->canDeleteRepeat) {?>
							<a class="deleteGroup" href="#">
								<?php echo Html::image('minus-sign.png', 'form', $this->tmpl, array('class' => 'fabrikTip', 'title' => FText::_('COM_FABRIK_DELETE_GROUP')));?>
							</a>
							<?php }?>
						</div>
					<?php } ?>
