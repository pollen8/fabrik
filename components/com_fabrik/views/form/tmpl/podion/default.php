...
<?php }?>
<div class="fabrikActions fabrik_buttons"><?php echo $form->resetButton;?> <?php echo $form->submitButton;?>
...
<?php 
if (JRequest::getInt('formid') == 7) {
	echo $this->loadTemplate('event_sidebar');
}?>
