...
if (!$app->isAdmin()) :
	throw new RuntimeException(Text::_('COM_FABRIK_ERR_ADMIN_LIST_TMPL_IN_FRONTEND'));
endif;
if ($pageClass !== '') :
...
if ($this->tablePicker != '') : ?>
	<div style="text-align: right">
		<?php echo Text::_('COM_FABRIK_LIST') ?>: <?php echo $this->tablePicker; ?>
	</div>
<?php endif;
