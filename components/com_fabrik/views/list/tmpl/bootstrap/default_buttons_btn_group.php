...
<div class="btn-group">
	<?php if ($this->canGroupBy) :?>
		<div class="btn-group">
			<a href="#" class="btn dropdown-toggle groupBy" data-toggle="dropdown">
				<?php echo Html::icon('icon-list-view', FText::_('COM_FABRIK_GROUP_BY'));?>
			</a>
	...
	<?php if ($this->showCSV) {?>
		<a href="#" class="btn csvExportButton">
			<?php echo Html::icon('icon-upload', FText::_('COM_FABRIK_EXPORT_TO_CSV')); ?>
		</a>
	<?php }?>
	...
	<?php if ($this->showCSVImport) {?>
		<a href="<?php echo $this->csvImportLink;?>" class="btn csvImportButton">
			<?php echo Html::icon('icon-download', FText::_('COM_FABRIK_IMPORT_FROM_CSV')); ?>
		</a>
	<?php }?>
