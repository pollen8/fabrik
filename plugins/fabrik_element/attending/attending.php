...
class PlgFabrik_ElementAttending extends PlgFabrik_Element
{
	...
	public function render($data, $repeatCounter = 0)
	{
		...
		$str[] = '<a class="btn btn-primary">' . FText::_('PLG_FABRIK_ELEMENT_ATTENDING_JOIN') . '</a>';
		$str += $this->attendeeList();
		$str[] = '</div>';
	...
	/**
	 * Get a Bootstrapped markuped attendee list.
	 *
	 * @return multitype:string
	 */
	protected function attendeeList()
	{
		$str = array();
		$str[] = '<div class="media">';
		...
		foreach ($attendees as $user)
		{
			...
			$str[] = '<img class="media-object" data-src="holder.js/64x64">';
			$str[] = '</a>';
			$str[] = '<div class="media-body">';
			$str[] = '<h4 class="media-heading">' . $user->get('name') . '</h4>';
			$str[] = '</div>';
		}
