...
class plgFabrik_ElementFileupload extends plgFabrik_Element
{
	...
	function elementJavascript($repeatCounter)
	{
		...
		if ((int)$p->get('fileupload_crop', 0) == 1) {
			...
			FabrikHelperHTML::script('media/com_fabrik/js/mcl/CANVAS.js', false);
			FabrikHelperHTML::script('media/com_fabrik/js/mcl/CanvasItem.js', false);
			FabrikHelperHTML::script('media/com_fabrik/js/mcl/Cmorph.js', false);
			FabrikHelperHTML::script('media/com_fabrik/js/mcl/Layer.js', false);
			FabrikHelperHTML::script('media/com_fabrik/js/mcl/LayerHash.js', false);
			FabrikHelperHTML::script('media/com_fabrik/js/mcl/Thread.js', false);


			FabrikHelperHTML::script('media/com_fabrik/js/canvas-extra.js', false);
		}
	...
	function dataConsideredEmpty($data, $repeatCounter)
	{
		if ((int)JRequest::getVar('rowid', 0) != 0) {
			if (JRequest::getVar('task') == '') {
				$r= parent::dataConsideredEmpty( $data, $repeatCounter);
				return $r;
			}
	...
	function render($data, $repeatCounter = 0)
	{
		...
		$values = FabrikWorker::JSONtoData($value, true);
		$render =& $this->loadElement($value);
		$render->output = '';
		if ($params->get('fu_show_image') != '0' && !$params->get('ajax_upload')) {
