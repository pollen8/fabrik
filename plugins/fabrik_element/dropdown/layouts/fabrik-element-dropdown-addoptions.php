...
<a href="#" title="<?php echo FText::_('COM_FABRIK_ADD'); ?>" class="btn btn-info toggle-addoption">
	<?php echo $d['add-image'];?>
	</a>
<div style="clear:left">
	<div class="addoption"><div><?php echo FText::_('COM_FABRIK_ADD_A_NEW_OPTION_TO_THOSE_ABOVE');?></div>

		<?php
		if (!$d['allowadd-onlylabel'] && $d['savenewadditions']) : ?>
