...
<select name="<?php echo $d->name . '[year]';?>" class="input-small fabrik_filter">
...
<select name="<?php echo $d->name . '[month]';?>" class="input-small fabrik_filter">
...
<select name="<?php echo $d->name . '[day]';?>" class="input-small fabrik_filter">
