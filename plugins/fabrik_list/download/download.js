var fbTableDownload = new Class({
	...
	watchButton : function() {
		...
		button.addEvent('click', function(e) {
			...
			this.list.getForm().getElement('input[name=fabrik_listplugin_name]').value = 'download';
			this.list.getForm().getElement('input[name=fabrik_listplugin_renderOrder]').value = button.name.replace('download-', '');
