...
class PlgFabrik_FormJUser extends plgFabrik_Form
{
	...
	public function onBeforeStore($params, &$formModel)
	{
		...
		if ($isNew)
		{
			...
			/**
			 * $$$ hugh - added an option to totally disable email sending, for cases where
			 * people want to handle that themselves in email plugins.
			 *
			 * http://fabrikar.com/forums/index.php?threads/juser-plugin.36288/
			 */

			if ($params->get('juser_bypass_accountdetails', '0') != '2')
			{
